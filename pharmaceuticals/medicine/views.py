from .my_views.company_views import home, list_company, add_company, get_company, delete_company, edit_company, render
from .my_views.company_purchase_views import list_company_purchase, add_company_purchase, get_company_purchase, delete_company_purchase, edit_company_purchase
from .my_views.customer_views import list_customer, add_customer, get_customer, delete_customer, edit_customer
...
from .my_views.medicine_views import list_medicine, add_medicine, get_medicine, delete_medicine, edit_medicine
