...
from .my_views.customer_purchase_views import list_customer_purchase, customer_purchase, add_customer_purchase, get_customer_purchase, delete_customer_purchase, edit_customer_purchase, search_customer_purchase
...
from .my_views.dashboard_views import home, remaining_stock, sales_statistics, debt, payment_statistics
from .my_views.report_views import remaining_debt_report
